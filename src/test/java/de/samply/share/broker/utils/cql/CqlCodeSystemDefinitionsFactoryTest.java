...
class CqlCodeSystemDefinitionsFactoryTest {
    ...
    private static final String EXPECTED_CODESYSTEM_DEFINITION_1 = "codesystem " + CODESYSTEM_NAME_1 + ": '" + CODESYSTEM_URL_1 + "'";
    private static final String EXPECTED_CODESYSTEM_DEFINITION_2 = "codesystem " + CODESYSTEM_NAME_2 + ": '" + CODESYSTEM_URL_2 + "'";
    ...
    void test_create_emptyDto() {
        ...
        assertThat("Error creating code system definition for empty DTO.", CqlTestHelper.trim(definitions), is(""));
    }
    ...
    void test_create_WithoutCodeSystem() {
        ...
        assertThat("Error creating code system definition for one field without code system.", CqlTestHelper.trim(definitions), is(""));
    }
    ...
    void test_create_WithCodeSystem() {
        ...
        String definitions = codeSystemDefinitionsFactory.create(queryDto);
        assertThat("Error creating code system definition for one field with code system.", CqlTestHelper.trim(definitions), is(EXPECTED_CODESYSTEM_DEFINITION_1));
    }
    ...
    void test_create_WithCodeSystem_oneFixCodeSystem() {
        ...
        assertThat("Wrong number of code system definitions for SampleMaterialType.", StringUtils.countMatches(CqlTestHelper.trim(definitions), EXPECTED_CODESYSTEM_DEFINITION_1), is(1));
        assertThat("Wrong number of code system definitions for StorageTemperature.", StringUtils.countMatches(CqlTestHelper.trim(definitions), EXPECTED_CODESYSTEM_DEFINITION_2), is(1));
    }
    ...
    void test_create_WithTheSameCodeSystemInTwoEntities() {
        ...
        String definitions = codeSystemDefinitionsFactory.create(queryDto);
        assertThat("Error creating code system definition for two fields in two entities with the same code system.", CqlTestHelper.trim(definitions), is(EXPECTED_CODESYSTEM_DEFINITION_1));
    }
