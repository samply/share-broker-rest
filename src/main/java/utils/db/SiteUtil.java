 ...
 * 
 * @see de.samply.share.broker.model.db.tables.pojos.Site
 */
public final class SiteUtil {
    
    private static final Logger logger = LogManager.getLogger(de.samply.share.broker.utils.db.SiteUtil.class);
