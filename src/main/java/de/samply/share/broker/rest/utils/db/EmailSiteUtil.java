 ...
 * 
 * @see de.samply.share.broker.model.db.tables.pojos.EmailSite
 */
public final class EmailSiteUtil {
    
    private static final Logger logger = LogManager.getLogger(de.samply.share.broker.utils.db.EmailSiteUtil.class);
