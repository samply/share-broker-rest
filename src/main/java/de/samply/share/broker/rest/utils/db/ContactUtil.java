 ...
 * 
 * @see de.samply.share.broker.model.db.tables.pojos.Contact
 */
public final class ContactUtil {
    
    private static final Logger logger = LogManager.getLogger(de.samply.share.broker.utils.db.ContactUtil.class);
