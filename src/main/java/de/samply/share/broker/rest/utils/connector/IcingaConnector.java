...
import de.samply.share.broker.utils.connector.IcingaReportItem;
...
public class IcingaConnector {
    ...
    private static final Logger logger = LogManager.getLogger(de.samply.share.broker.utils.connector.IcingaConnector.class);
