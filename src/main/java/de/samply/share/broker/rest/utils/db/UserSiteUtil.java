...
import de.samply.share.broker.rest.utils.MailUtils;
 ...
 * 
 * @see de.samply.share.broker.model.db.tables.pojos.UserSite
 */
public final class UserSiteUtil {

    private static final Logger logger = LogManager.getLogger(de.samply.share.broker.utils.db.UserSiteUtil.class);
