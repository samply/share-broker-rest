 ...
 * Objects
 * 
 * @see de.samply.share.broker.model.db.tables.pojos.Tokenrequest
 */
public final class TokenRequestUtil {

    private static final Logger logger = LogManager.getLogger(de.samply.share.broker.utils.db.TokenRequestUtil.class);
