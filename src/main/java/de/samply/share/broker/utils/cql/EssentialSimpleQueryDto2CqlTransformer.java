...
public class EssentialSimpleQueryDto2CqlTransformer {
    ...
    private static final CqlConfig.Codesystem SAMPLE_MATERIAL_TYPE = new CqlConfig.Codesystem("SampleMaterialType",
    ...
    public String toQuery(EssentialSimpleQueryDto essentialSimpleQueryDto, String entityType) {
        CqlCodeSystemDefinitionsFactory codeSystemDefinitionsFactory = new CqlCodeSystemDefinitionsFactory(cqlExpressionFactory);
        ...
        String codeSystemDefinitions = codeSystemDefinitionsFactory.create(essentialSimpleQueryDto, SAMPLE_MATERIAL_TYPE);
        ...
        return cqlExpressionFactory.createLibrary(entityType, codeSystemDefinitions, singletonStatements,
