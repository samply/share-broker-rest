...
public class IcingaController {
    ...
    /**
     * Updates the instant at which the last version report of a bank was send to the current instant taken from
     * {@code clock} if either no instant was recorded or the already recorded instant is older than one minute.
     *
